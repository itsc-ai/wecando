...
class Music(models.Model):
    music_num = models.AutoField(primary_key=True)
...
class Writen(models.Model):
    ...
    id = models.ForeignKey(AuthUser, models.DO_NOTHING, db_column='id')
    diary_num = models.ForeignKey(Diary, models.DO_NOTHING, db_column='diary_num')
    music_num = models.ForeignKey(Music, models.DO_NOTHING, db_column='music_num')
    wise_num = models.ForeignKey(Wise, models.DO_NOTHING, db_column='wise_num')
    type_num = models.ForeignKey(Type, models.DO_NOTHING, db_column='type_num')
    writen_title = models.CharField(max_length=100)
    writen_content = models.CharField(max_length=5000)
